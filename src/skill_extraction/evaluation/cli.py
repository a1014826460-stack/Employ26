...
用法::
    ...
    python -m src.skill_extraction.evaluation.cli run
    python -m src.skill_extraction.evaluation.cli compare v1 v2
    python -m src.skill_extraction.evaluation.cli list
"""
...
def cmd_compare(
    ...
    """
    from .registry import get_record_by_version
